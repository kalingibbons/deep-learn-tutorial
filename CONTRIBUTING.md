...
Welcome to `deep-learn-tutorial` contributor's guide.
...
If you experience bugs or general issues with `deep-learn-tutorial`, please have a look
...
You can help improve `deep-learn-tutorial` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`deep-learn-tutorial` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `deep-learn-tutorial`'s files. While this mechanism can
...
```
conda create -n deep-learn-tutorial python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/deep-learn-tutorial.git
   cd deep-learn-tutorial
   ```
...
5. Install [pre-commit]:
   ...
   `deep-learn-tutorial` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/deep-learn-tutorial
[issue tracker]: https://github.com/<USERNAME>/deep-learn-tutorial/issues
